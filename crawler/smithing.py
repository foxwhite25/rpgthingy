...
url = 'https://wiki.melvoridle.com/index.php?title=Smithing'
headers = {
...
def get_urls(url):
    ...
    black_list = ['/index.php?title=Smithing_Skillcape', '/index.php?title=Puff,_the_Baby_Dragon']
...
def get_data(url):
    ...
    values (?,?,?,?,?,?,?)''', (i ,to, fr, time, xp, level, 'smithing'))
    conn.commit()
